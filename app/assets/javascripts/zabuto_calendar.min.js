        ...
        function e(z, y) {
            ...
            if (w !== false) {
                $(w).each(function(F, H) {
                    ...
                    if (typeof(H.id_rails) !== "undefined") {
                        D.attr("id_rails", H.id_rails)
                    }
                    ...
                    if (typeof(H.badge) !== "undefined" && H.badge !== false) {
                        ...
                        var E = I.data("day");
                        I.html('<span class="badge heart badge-event' + C + '"><span class="entypo-heart"></span><span class="heart-text">' + E + '</span>' + "</span>"  )
                    }
